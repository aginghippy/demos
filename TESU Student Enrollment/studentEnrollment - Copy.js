...
$(document).ready(function(){
    ...
    storyNodesMeta = [
      ...
      },
      {
        ...
        /*  {
            ...
            "searchQuery": true,
            "searchContent": false,
          }, // 0 */ // root node automatically generated by creator
          ...
          }, //topic 1,0
          {
            "topicID": 1,
            "nodeOrder": 1,
            "nodeDisplayName": "Cost of Undergraduate Degree",
          ...
          }, //topic 1,1
          {
            "topicID": 1,
            "nodeOrder": 2,
            "nodeDisplayName": "FAQs: On Scholarships to TESU Students",
            "nodeTemplateCategory": "textParagraphs",
          ...
          }, //topic 1,3
          {
            "topicID": 1,
            "nodeOrder": 4,
            "nodeDisplayName": "Financial Aid Handbook",
          ...
          }, //topic 1,4
          {
            "topicID": 1,
            "nodeOrder": 5,
            "nodeDisplayName": "Financial Aid Shopping List",
            "nodeTemplateCategory": "textParagraphs",
            ...
            "nodeInputContent": [
              {
                "bulletGroupStrings": [
                  ...
                  ["In 2015, Thomas Edison State University was awarded university status"],
                  ["The university offers associate, bachelor's and master's degrees in more than 100 areas of study in 5 of the schools" ],
          ...
          }, //topic 3,0
          {
            "topicID": 3,
            "nodeOrder": 1,
            "nodeDisplayName": "The Difference We Make",
            "nodeTemplateCategory": "bulletedText",
            ...
            "nodeInputContent": [
              {
                "bulletGroupHeader": "Many colleges say they serve adults. So why choose us?",
                "bulletGroupStrings": [
                  ["Because serving busy, motivated adults is the only thing we do"],
                  ["Our focus is and always has been to serve adults"],
                  ["As one of New Jersey's senior public institutions of higher learning, we’re regionally accredited." ]
                ]
              },
              {
                "bulletGroupHeader": "Because you’ll benefit from our experience",
                "bulletGroupStrings": [
                  ["We are one of the oldest colleges in the country dedicated exclusively to adults"],
                  ["We design programs specifically for you, the adult student"],
                  ["Both bachelor's degree or graduate degree catering to needs of adult learners." ]
                ]
              },
              {
                "bulletGroupHeader": "Because the value is exceptional",
                "bulletGroupStrings": [
              ...
              {
                "bulletGroupHeader": "Because you want to earn your achievement.",
                "bulletGroupStrings": [
                  ["You are motivated and talented"],
                  ["You want to finish what you started"],
                  ["Or take your achievement to the next level" ]
                ]
              }
          ...
          }, //topic 3, 2
          {
            ...
            "nodeInputContent": [ // array of arrays with multiple categories of images - KeyNotes, Award Night, etc

              {
                ...
                "mediaSubtitle": "Voices og Our Students",
                "mediaSource": "Thomas Edison State University",
    ...
    storyNodesInputContent = [
      ...
      }, //topic 1,0
      {
        ...
        "nodeInputContent": [
          {
            "bulletGroupHeader": "In State New Jersey Students",
            "bulletGroupStrings": [
          ...
          {
            "bulletGroupHeader": "Out of State New Jersey Students",
            "bulletGroupStrings": [
      ...
      }, //topic 1,3
      {
        ...
        "nodeInputContent": [
          {
            "documentTitle": "Financial Aid Handbook and Form",
            "documentSubtitle": "",
            ...
            "uploadedDocument": "https://www.aws.."
          }
      ...
      }, //topic 1,4
      {
        ...
        "nodeInputContent": [
          {
            "parargraphTitle": "This tool is provided as part of Thomas Edison State University’s commitment to the Principles of Excellence under Presidential Executive Order 13607",
            "parargraphSubtitle": "",
            "contentSource": "",
            "paragraphHeader" : "Only for Nursing students in the Accelerated 2nd Degree BSN Program.",
            "paragraphBullets" : ["Thomas Edison State University provides two versions of the Financial Aid Shopping Sheet (FASS).",
              "The FASS is designed to help you estimate the cost of attending Thomas Edison State University during the current Academic Year",
              "Identify potential sources of financial aid so you can easily compare Thomas Edison State University with other institutions and make an informed decision about where to attend school",
              "The first version of the Financial Aid Shopping Sheet is available to any prospective, applicant, or enrolled student.",
              "A second version is available to currently enrolled students via your Online Student Services account and will display detailed financial aid information if you have been awarded such"]
          },
        ],
