...
$(document).ready(function(){
    ...
    $("#paymentProcessor").click(publishPaymentProcessor);
   ...
   // if you want to skip to new page; else temlateCategory is "terminateConversation"   [{"skipTo": "https://www.google.com"}]
    storyNodesMeta = [
      {
        "metaData": {
          "trid": 534
        ...
        "returnedData": [
          {
            "topicID": 0,
            "nodeOrder": 0,
            "nodeDisplayName": "Please donate some money",
    ...
    paymentProcessorNodeInputContent =  {
        "topicID": 0,
        "nodeOrder": 0,
        "nodeDisplayName": "Please donate some money",
        "nodeTemplateCategory": "paymentProcessor",
